...
glu_No = 10000;
N_ampar=100 ; %AMPAR on PSD
runs = 160;

period = 4; % P4, P8, P12, P18, P30
ratio = 0.75; % GluA2 / (GluA2 + GluA4)
...
for i = 1: runs
    ...
    %%%%  fast GluAs  %%%%
    name = ['GluA4_P',num2str(period),'_',num2str(fileName), '.mat'];
    load(name);
    ...
    Po_a4 = open_state_a4./(N_ampar*(1-ratio)); % open probability on PSD
