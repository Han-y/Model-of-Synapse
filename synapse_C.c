...
#define     amparState_C0_a2       1
#define     amparState_C1_a2       2
#define     amparState_C2_a2       3
#define     amparState_D3_a2       4
#define     amparState_D4_a2       5
#define     amparState_D5_a2       6
#define     amparState_D6_a2       7
#define     amparState_D7_a2       8
#define     amparState_O_a2        9


#define     k1_a2        (   1.1*1.8412E7 *1.0/1000.0 )
#define     k2_a2        (   1.1*4E6      *1.0/1000.0 )
#define     k5_a2        (   1.1*1.9863E7 *1.0/1000.0 )
...
#define     k1_a4        (   1.0*1.8412E7 *1.0/1000.0 )
#define     k2_a4        (   1.0*4E6      *1.0/1000.0 )
#define     k5_a4        (   1.0*1.9863E7 *1.0/1000.0 )
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
 ...
 /* int32   *ampar_ligand2      =  (int32*)getMATLABvalue(getMATLABfield("ampar", "ligand2"));       */ /* zeros(1, amparNo, 'uint32'), ... */
    ...
    double  Q_C1_C1_a2, Q_D3_D3_a2, Q_C1_C1_a4, Q_D3_D3_a4;
...
*/                    
                ...
                if (kineticScheme == kinetics_a2 - 1) {                    
                    /* update concentration-sensitive transitions */
                    Q_transition[kineticScheme][amparState_C0_a2-1][amparState_C1_a2-1] = k1_a2 *concentration;
                    Q_transition[kineticScheme][amparState_C1_a2-1][amparState_C2_a2-1] = k2_a2 *concentration;
                    Q_transition[kineticScheme][amparState_D3_a2-1][amparState_D4_a2-1] = k5_a2 *concentration;
                    
                    /* update diagonal */
                    Q_transition[kineticScheme][amparState_C0_a2-1][amparState_C0_a2-1] =            - Q_transition[kineticScheme][amparState_C0_a2-1][amparState_C1_a2-1];
                    Q_transition[kineticScheme][amparState_C1_a2-1][amparState_C1_a2-1] = Q_C1_C1_a2 - Q_transition[kineticScheme][amparState_C1_a2-1][amparState_C2_a2-1];
                    Q_transition[kineticScheme][amparState_D3_a2-1][amparState_D3_a2-1] = Q_D3_D3_a2 - Q_transition[kineticScheme][amparState_D3_a2-1][amparState_D4_a2-1];
                } else {
                    /* update concentration-sensitive transitions */
