...
period = 30% P4, P8, P12, P18, P30
ratio = 0.25; % GluA1 / (GluA1 + GluA4)
...
%         open_state_total_a1 = amparStates_a1(:,4)/10;
        ...
        if SpillOver == 1
            ...
            open_state_a1 = open_state_a1 + NND_No * amparStates(:,4); % AMPAR open number     
        end
...
%         open_state_total_a4 = amparStates_a4(:,4)/10;       
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         amp = -I_max;
%         save('P12_CTRL.mat', 'amp', 'decayTime','riseTime' );
beep;