...
function synapse_sim_on_PSD_STROM(gluPerVesicle, amparNo_a1, amparNo_a4, ratio, factor,...
                                  fileNo,period, group,...
...
%--------------------------------------------------------------------------  
    ...
    for i = 1:2
        if i == 1 % GluA1, stands for slow-GluAs
            ...
            S.fileName = fileNo;               
            S.period = period;
            synapse_fun_0_5_3_subregions(S);     % run the simulation with the parameters specified in S
